...
//         .where('tag', tag)
//       // deleted all photo of this account using  files_pivot
//       if (files_pivot) {
//         for (let file_pivot of files_pivot) {
//           var file = await Image.find(file_pivot.file_id)
//           if (file) {
//             await file.delete()
//           }
//         }
