...
class Phone {
  ...
  @override
  String toString() {
    return 'Phone(id: $id, value: $value, validatedAt: $validatedAt, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, relatedId: $relatedId, relatedType: $relatedType)';
  }
